		...
		<section>
			...
			<div class="btn-acoes">
				<span class="input-group-btn btn-mecanico">
					<button class="btn btn-default btn-amarelo" type="button">Buscar Peça</button>
				</span>
				<span class="input-group-btn btn-mecanico">
					<button class="btn btn-default btn-amarelo" type="button">Enviar</button>
				</span>
			</div>

			<div class="label-dados input-orcamento">
				<p class="nome-dados">Valor da mão de obra:  </p>
				<input type="text" id="cadastro" name="Cadastro" class="form-control input-dados input-valor">
			</div>
